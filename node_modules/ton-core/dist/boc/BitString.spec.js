...
describe('BitString', () => {
    it('should read bits', () => {
        let bs = new BitString_1.BitString(Buffer.from([0b10101010]), 0, 8);
    ...
    it('should equals', () => {
        let a = new BitString_1.BitString(Buffer.from([0b10101010]), 0, 8);
        let b = new BitString_1.BitString(Buffer.from([0b10101010]), 0, 8);
        let c = new BitString_1.BitString(Buffer.from([0, 0b10101010]), 8, 8);
    ...
    it('should format strings', () => {
        expect(new BitString_1.BitString(Buffer.from([0b00000000]), 0, 1).toString()).toEqual('4_');
        expect(new BitString_1.BitString(Buffer.from([0b10000000]), 0, 1).toString()).toEqual('C_');
        expect(new BitString_1.BitString(Buffer.from([0b11000000]), 0, 2).toString()).toEqual('E_');
        expect(new BitString_1.BitString(Buffer.from([0b11100000]), 0, 3).toString()).toEqual('F_');
        expect(new BitString_1.BitString(Buffer.from([0b11100000]), 0, 4).toString()).toEqual('E');
        expect(new BitString_1.BitString(Buffer.from([0b11101000]), 0, 5).toString()).toEqual('EC_');
    });
