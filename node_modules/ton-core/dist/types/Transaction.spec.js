...
describe('Transaction', () => {
    it('should parse transaction', () => {
        ...
        const cell = Cell_1.Cell.fromBoc(Buffer.from(boc, 'base64'))[0];
        const tx = (0, Transaction_1.loadTransaction)(cell.beginParse());
        const cell2 = (0, Builder_1.beginCell)().store((0, Transaction_1.storeTransaction)(tx)).endCell();
